...
const getStatus = (action) => {
  if (
    ["login_success", "first_login", "password_created", "otp_sent"].includes(
      action,
    )
  )
    return "success";
  if (["login_failed", "otp_failed", "login_blocked"].includes(action))
    return "failed";
  return "success";
};
                    ...
                    logs.map((log, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className={`${styles.td} ${styles.ip}`}>
                            {log.ip_address || "—"}
                          </td>
                        </tr>
                      );
