...
export default function LandingPage() {
  ...
  const cursosFiltrados =
    filtro === "Todos" ? cursos : cursos.filter((c) => c.category === filtro);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Cursos diseñados por profesionales para llevarte de principiante a
            ...
            {categorias.map((cat) => (
              <button
                ...
                style={{
                  ...
                  color: filtro === cat ? "#a5b4fc" : "rgba(255,255,255,0.35)",
                  outline:
                    filtro === cat ? "1px solid rgba(99,102,241,0.4)" : "none",
      ...
      >
        ...
        >
          © 2026 DevCourses — Todos los derechos reservados
        </p>
      </div>
